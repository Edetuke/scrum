...
const AboutCapacity = () => {
  return (
    <div className={classes.aboutCapacity}>
      <img
        className={classes.capacityimg}
        src={capacityimg}
        alt="capacity-calculator"
      />
      <div className={classes.capacityText}>
        ...
        <ul>
          ...
          <li>
            ...
            View current and upcoming week capacity
          </li>
        </ul>
      </div>
    </div>
